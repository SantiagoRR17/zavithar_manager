...
- **Public repo ⇒ the security rules are the only real access control.** The API key is visible by design (ADR 0008) and is not a secret, but anything the rules do not forbid is open to the internet.
