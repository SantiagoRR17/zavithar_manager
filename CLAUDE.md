...
4. **Polish** — **in progress** on `milestone-4-polish`. Recurring transactions ✅, budgets ✅, charts ✅, editable categories ✅, CSV export ✅ (shipped early, inside the backup card). **Dark mode refinements still outstanding.**
